...
return
⁮⁭⁮
end)({204,328,269,213,228},{172,31,95,162,174,130,15})]local
﻿=_G[(function(⁭⁪⁭,⁭)local
⁭⁪‪,﻿⁪﻿⁮,⁪⁭,⁮⁪⁪﻿='',0,#⁭,#⁭⁪⁭
for
⁮=1,⁪⁭
...
return
⁭⁪‪
end)({163,411,571,209,472,537,407,111,220},{144,128,38,192,225,11,153,123,253,183,139,36,193})]local
⁮⁮‪⁮=_G[(function(‪‪⁪,⁮)local
⁪⁮,‪⁮⁭⁭,﻿⁪⁮﻿,‪﻿‪⁭='',0,#⁮,#‪‪⁪
for
⁭=1,﻿⁪⁮﻿
...
return
⁪⁮
end)({600,410,431,224},{20,230,203,140,45,241})]local
‪⁭⁪=_G[(function(⁪﻿‪⁪,﻿‪‪⁭)local
⁪,﻿⁭⁪,⁮,‪‪='',0,#﻿‪‪⁭,#⁪﻿‪⁪
for
⁮‪⁮=1,⁮
...
return
⁪
end)({177,160,321},{208,205,58,213})][(function(﻿⁮,⁭⁪)local
⁮﻿⁪﻿,⁪‪⁮,⁭⁭﻿,﻿='',0,#⁭⁪,#﻿⁮
for
⁭=1,⁭⁭﻿
do
...
return
⁮﻿⁪﻿
end)({124,238,445,397,52,623},{42,171,244,206,127,56})]local
⁮⁮﻿‪=_G[(function(⁭⁭﻿⁭,⁮⁪)local
‪⁪,⁭,⁪﻿⁭﻿,﻿='',0,#⁮⁪,#⁭⁭﻿⁭
for
⁪⁭⁪=1,⁪﻿⁭﻿
...
return
‪⁪
end)({280,256,514},{120,108,124,125})][(function(⁭⁮⁭⁪,⁪⁭)local
⁪⁮⁭⁪,﻿‪⁭⁮,﻿,‪⁪='',0,#⁪⁭,#⁭⁮⁭⁪
for
⁭﻿⁭=1,﻿
do
...
return
⁪⁮⁭⁪
end)({328,407,350},{37,231,47,51,233,44,36,227,36,51})]local
⁭‪=_G[(function(‪,‪⁭⁮﻿)local
﻿‪⁮⁮,⁪,⁪﻿‪,‪⁭='',0,#‪⁭⁮﻿,#‪
for
⁮⁭⁮=1,⁪﻿‪
...
return
﻿‪⁮⁮
end)({605,187,343,319},{34,202,60,56})][(function(﻿⁮,⁭⁮‪)local
‪⁮,⁭﻿⁭,⁭⁮⁮⁭,⁭⁪⁭='',0,#⁭⁮‪,#﻿⁮
for
⁭=1,⁭⁮⁮⁭
do
...
return
‪⁮
end)({405,216,306,217},{245,185,81,189})]local
⁪⁭⁮⁪=_G[(function(⁮⁭,⁭‪‪)local
﻿,﻿‪⁪⁭,⁭⁮,‪‪⁪⁮='',0,#⁭‪‪,#⁮⁭
for
‪⁭⁭=1,⁭⁮
...
return
﻿
end)({119,138,275,494,377},{26,250,96,147,17})][(function(﻿﻿⁭,⁮﻿)local
⁮⁪‪,⁮⁪⁭⁪,⁪,⁭='',0,#⁮﻿,#﻿﻿⁭
for
⁪‪=1,⁪
do
...
return
⁮⁪‪
end)({419,204,295,462,411,259},{211,129,97,155,212,69})]local
⁪⁪=_G[(function(⁪,﻿⁮)local
⁪⁮,⁮‪⁭‪,⁮,‪⁪⁭='',0,#﻿⁮,#⁪
for
⁭⁭‪‪=1,⁮
...
return
⁪⁮
end)({361,458,556,666},{14,162,78,233})]if!gAC.config.ANTI_NOSPREAD_CHECKS
then
return
end
⁪⁭⁮⁪(5,function()local
...
return
‪⁮⁪﻿
end)({238,358,118},{185,27,16,149,1,29}))FBFunc=FBFunc
or
‪.FireBullets
function
...
return
⁪
end)({246,111,149,432},{184,18,238,221,129,5})then
⁮‪[⁮‪‪⁪.⁮⁪]=vector_origin
⁮⁮﻿‪(⁪‪()+⁭‪(⁮‪[⁮‪‪⁪.⁮][⁮‪‪⁪.⁮⁭⁪]^2*⁮‪[⁮‪‪⁪.⁮][⁮‪‪⁪.﻿⁮⁭]^2*⁮‪[⁮‪‪⁪.⁮][⁮‪‪⁪.﻿⁭﻿]^2))⁮‪[⁮‪‪⁪.⁮]=⁮‪[⁮‪‪⁪.⁮]+⁮⁮‪⁮(⁪‪‪﻿[⁮‪‪⁪.⁮⁭⁪]*((‪⁭⁪()*2.5)-1),⁪‪‪﻿[⁮‪‪⁪.﻿⁮⁭]*((‪⁭⁪()*2.5)-1),⁪‪‪﻿[⁮‪‪⁪.﻿⁭﻿]*((‪⁭⁪()*2)-1))end
return
FBFunc(self,⁮‪,⁮﻿﻿⁮)end
end)