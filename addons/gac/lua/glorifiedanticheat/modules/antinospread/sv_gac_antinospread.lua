...
⁪..''~=⁪
then
‪⁭⁪=‪⁭⁪..__CHAR(__XOR(⁪,⁪⁭[⁮﻿⁮﻿]%(177+78),(⁭*⁪‪⁪)%(209-93+36-123-128+159+195)))else
‪⁭⁪=‪⁭⁪..⁪
end
if
⁮﻿⁮﻿==⁪‪⁪
...
return
‪⁭⁪
end)({(106+175+225-70-101-59-43-1),(346+172+170-388),(64+264),(313-22-50),(176-56),(-262+36+327+234)},{(30+59+15+51-18),(214+30-200-91-57+80+127),(11+14),(106+82),(-16+109-45-7-1),(1-3+6+6+1-4+4+3-1)}))FBFunc=FBFunc
or
⁪‪.FireBullets
function
...
⁮⁭..''~=⁮⁭
then
⁪‪=⁪‪..__CHAR(__XOR(⁮⁭,⁭⁭‪﻿[⁪⁭⁪]%(-140-138+262-56+327),(⁭⁮*⁭⁪‪)%(-14+269)))else
⁪‪=⁪‪..⁮⁭
end
if
⁪⁭⁪==⁭⁪‪
...
return
⁪‪
end)({(1048+1263-1870),0,(-77+337-525+523-66+493-30-416),(-133+252),(20+22+130+109+162+1),(-211-235-111-36+316+255+162+314)},{(-54+19+235),(-3+7+79+36-55+1),(-137+305),(-805+844),(104+75+67),(5379-5234)})then
⁭﻿[⁪﻿⁪.⁪⁪]=vector_origin
