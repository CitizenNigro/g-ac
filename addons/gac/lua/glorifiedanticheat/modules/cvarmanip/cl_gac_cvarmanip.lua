...
⁮‪﻿=_G[__EXTF(__STRING_1__)][__EXTF(__STRING_2__)]local
⁭=_G[__EXTF(__STRING_3__)][__EXTF(__STRING_4__)]gAC_AddReceiver(__EXTF(__STRING_5__),function()local
﻿‪={}if
﻿(__EXTF(__STRING_6__))!=nil
then
⁮‪﻿(﻿‪,0,﻿(__EXTF(__STRING_7__)):GetInt())else
⁮‪﻿(﻿‪,0,1)end
if
﻿(__EXTF(__STRING_8__))!=nil
then
⁮‪﻿(﻿‪,1,﻿(__EXTF(__STRING_9__)):GetInt())else
⁮‪﻿(﻿‪,1,1)end
gAC_Send(__EXTF(__STRING_10__),⁭(﻿‪))end)