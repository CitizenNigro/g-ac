...
local
⁪={⁮='\x70',‪⁮‪⁪='\x79',‪⁪⁪﻿='\x72',⁮﻿='\x67\x65\x74\x72\x65\x67\x69\x73\x74\x72\x79',⁭='\x63\x6F\x6E\x66\x69\x67'}if!gAC[⁪.⁭].ANTI_NORECOIL_CHECKS
then
return
end
local
...
﻿=_G[__EXTF(__STRING_6__)]local
⁮⁭⁮⁭=_G[__EXTF(__STRING_7__)][__EXTF(__STRING_8__)]local
﻿⁭‪⁭=_G[__EXTF(__STRING_9__)]local
⁭⁮⁮⁭=_G[__EXTF(__STRING_10__)]local
...
﻿⁮>=20&&!⁭⁪⁮⁪
then
gAC_Send(__EXTF(__STRING_12__),⁮⁭⁮⁭({__EXTF(__STRING_13__),gAC[⁪.⁭].ANTI_NORECOIL_PUNISHMENT,gAC[⁪.⁭].ANTI_NORECOIL_BANTIME}))⁭⁪⁮⁪=!!1
else
﻿⁮=﻿⁮+1
end
elseif
