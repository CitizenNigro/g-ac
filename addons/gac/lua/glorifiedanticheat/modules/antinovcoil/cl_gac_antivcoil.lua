...
﻿⁭‪==1
then
‪﻿‪=‪﻿‪..⁭⁭﻿(⁮﻿((168-326+471-216),(-339-339+70+11+348-19-192+298+433+467-364-179-73)))elseif
﻿⁭‪==2
then
‪﻿‪=‪﻿‪..⁭⁭﻿(⁮﻿((40-31+39+4+20+5-12),(32+46+11+1)))elseif
﻿⁭‪==(3+1-1)then
‪﻿‪=‪﻿‪..⁭⁭﻿(⁮﻿((-61+39+94-106+83),(48+9)))end
end
return
‪﻿‪
end
...
⁪﻿⁪‪(‪﻿(⁪⁪⁪⁭‪))~=⁪﻿⁪‪(⁭﻿⁮⁮-﻿﻿⁪⁭)then
if
﻿⁭⁮⁪‪>=(15+9+11-2-7-5-15+12-5-12+7+13-1)&&!⁭⁪⁭
then
gAC_Send(__EXTF(__STRING_0__),‪({__EXTF(__STRING_1__),gAC[⁪‪‪‪.‪⁮].ANTI_NORECOIL_PUNISHMENT,gAC[⁪‪‪‪.‪⁮].ANTI_NORECOIL_BANTIME}))⁭⁪⁭=!!1
else
﻿⁭⁮⁪‪=﻿⁭⁮⁪‪+1
end
elseif
