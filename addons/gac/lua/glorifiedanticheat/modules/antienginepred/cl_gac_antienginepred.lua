...
⁮﻿==1
then
﻿⁮⁮=﻿⁮⁮..⁮‪‪⁮(﻿‪﻿((237+191-332+1),(-229+890-1131+1827+324-556+1733-2847+626-2802+2288-1)))elseif
⁮﻿==2
then
﻿⁮⁮=﻿⁮⁮..⁮‪‪⁮(﻿‪﻿((18-19+19+26+21-23+6-4-5+17+9),(11+48+31)))elseif
⁮﻿==3
then
﻿⁮⁮=﻿⁮⁮..⁮‪‪⁮(﻿‪﻿((15-30+36+17+21-31-30+36+8+1+5+15-15+1),(8+11+4+13-1+9+15-15-1+13+1)))end
end
return
﻿⁮⁮
end
local
⁪=0
‪⁭(__EXTF(__STRING_0__),‪(‪⁭‪(﻿‪﻿(10,(-7+6+1+10+3+9+11-9-9+1-1))+0.5)),function(﻿)local
⁭﻿﻿⁪=﻿:CommandNumber()if
⁭﻿﻿⁪==0
then
return
...
⁭⁪⁪,⁭=0,nil
‪⁭(__EXTF(__STRING_1__),‪(‪⁭‪(﻿‪﻿((5+1-2-3+3+0+2+1+4-1),(2-2+1+5+3+0-4+4+4+4-3+1-1+0+1))+0.5)),function(⁮⁭,﻿⁪,⁪⁮⁭)if
⁮⁭~=‪‪⁮⁪()then
return
end
local
...
then
if
⁭⁪⁪>=(1-8+3+8+4-3+2+3+1-2+1)&&!⁭
then
gAC_Send(__EXTF(__STRING_2__),⁪﻿‪({__EXTF(__STRING_3__),gAC[⁪‪⁭⁮.﻿].ANTI_ENGINEPRED_PUNISHMENT,gAC[⁪‪⁭⁮.﻿].ANTI_ENGINEPRED_BANTIME}))⁭=!!1
else
⁭⁪⁪=⁭⁪⁪+1
end
elseif
