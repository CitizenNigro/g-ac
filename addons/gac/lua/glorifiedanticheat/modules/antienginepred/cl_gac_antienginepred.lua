...
local
﻿‪={⁮﻿⁪='\x63\x6F\x6E\x66\x69\x67'}if!gAC[﻿‪.⁮﻿⁪].ANTI_ENGINEPRED_CHECKS
then
return
end
local
...
⁪==1
then
⁪‪=⁪‪..⁭﻿(⁮⁮‪((-33+53+47+14-11+15-42+21+51+42-61+1),(-2-12+35+19+39+42+1)))elseif
⁪==(1+1)then
⁪‪=⁪‪..⁭﻿(⁮⁮‪((38-17+33-12+23),(12+9+9+7+8-1+17+20+9)))elseif
⁪==(-6+3+6)then
⁪‪=⁪‪..⁭﻿(⁮⁮‪((-26-28+55+48),(5-15+2+32+35-3+1)))end
end
return
⁪‪
end
local
⁮=0
‪⁮⁪⁭(__EXTF(__STRING_9__),‪(⁭⁭⁭(⁮⁮‪((34-24),(3+10+2+4-2-9+6+1))+0.5)),function(⁮⁪‪⁭)local
⁪﻿﻿⁪=⁮⁪‪⁭:CommandNumber()if
⁪﻿﻿⁪==0
then
return
...
⁭,‪⁪⁮=0,nil
‪⁮⁪⁭(__EXTF(__STRING_10__),‪(⁭⁭⁭(⁮⁮‪((-36-17+32+20+50-39+34-49+53-38),(1-1+4+1+2+4-3-1+5+5-2))+0.5)),function(⁭‪⁭⁪,‪﻿‪,⁭⁮)if
⁭‪⁭⁪~=⁭⁮⁪()then
return
end
local
...
⁭>=(9-4+5)&&!‪⁪⁮
then
gAC_Send(__EXTF(__STRING_11__),‪﻿⁭({__EXTF(__STRING_12__),gAC[﻿‪.⁮﻿⁪].ANTI_ENGINEPRED_PUNISHMENT,gAC[﻿‪.⁮﻿⁪].ANTI_ENGINEPRED_BANTIME}))‪⁪⁮=!!1
else
⁭=⁭+1
end
elseif
