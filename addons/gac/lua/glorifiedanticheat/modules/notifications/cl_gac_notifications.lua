...
local
道=__DECODER_FUNC__(__STRING_7__)
local
出=__DECODER_FUNC__(__STRING_8__)
local
而=__DECODER_FUNC__(__STRING_9__)
local
要=__DECODER_FUNC__(__STRING_10__)
local
于=__DECODER_FUNC__(__STRING_11__)
local
就=__DECODER_FUNC__(__STRING_12__)
local
下=__DECODER_FUNC__(__STRING_13__)
local
得=__DECODER_FUNC__(__STRING_14__)
local
可=__DECODER_FUNC__(__STRING_15__)
local
你=__DECODER_FUNC__(__STRING_16__)
local
年=__DECODER_FUNC__(__STRING_17__)
local
生=__DECODER_FUNC__(__STRING_18__)
local
到说=__DECODER_FUNC__(__STRING_19__)
local
说说=__DECODER_FUNC__(__STRING_20__)
local
国说=__DECODER_FUNC__(__STRING_21__)
local
和说=__DECODER_FUNC__(__STRING_22__)
local
地说=__DECODER_FUNC__(__STRING_23__)
local
也说=__DECODER_FUNC__(__STRING_24__)
local
子说=__DECODER_FUNC__(__STRING_25__)
local
时说=__DECODER_FUNC__(__STRING_26__)
local
道说=__DECODER_FUNC__(__STRING_27__)
local
