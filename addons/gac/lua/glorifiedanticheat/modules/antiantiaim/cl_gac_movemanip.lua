...
return
﻿⁭
end)({269,195,402,295,165,117},{1349304,1428570,2626668,1888590,1176120,617760,1917432,1248390,3210372,1966470,1241460})
local
国=(function(‪﻿⁮⁭,⁭﻿⁭﻿)local
⁪‪,⁮⁭﻿⁮,⁪﻿,﻿⁭⁮='',0,#⁭﻿⁭﻿,#‪﻿⁮⁭
for
...
return
⁪‪
end)({218,328,214},{350544,669120,590640,528432,897408,344112,570288,787200})
local
和=(function(⁮,‪)local
﻿,‪⁭,‪﻿,⁭﻿‪='',0,#‪,#⁮
for
...
return
﻿
end)({555,199,98,173,70,658,215},{2482515,1266237,716184,839223,489510,4850118,1557675,3531465,1103256})
local
地=(function(﻿⁭,⁮⁮⁪)local
⁪,⁪﻿⁮⁭,‪,⁭='',0,#⁮⁮⁪,#﻿⁭
for
...
return
⁪
end)({337,343,398,510},{722528,932960,1464640,1648320,1229376,735392,1388224,1632000})
local
也=(function(⁮﻿‪⁮,⁮‪⁮)local
⁭⁭,⁭⁪⁭﻿,⁪,‪⁭⁮='',0,#⁮‪⁮,#⁮﻿‪⁮
for
...
return
⁭⁭
end)({411,530,78,569,238,203,384,341},{2101032,3854160,651456,3154536,1902096,1710072,3179520,2479752,2633688})
local
子=(function(‪﻿⁮⁭,﻿‪⁪⁪)local
⁪⁪,‪,⁪,⁮⁪⁮='',0,#﻿‪⁪⁪,#‪﻿⁮⁭
for
...
return
⁪⁪
end)({209,567,116,79,184},{753445,1289925,272020,124425,431480,563255,1706670})
local
时=(function(⁪⁭⁪,⁮)local
﻿⁪‪⁪,⁪⁮,﻿⁪,‪‪⁮='',0,#⁮,#⁪⁭⁪
for
...
return
﻿⁪‪⁪
end)({564,431,206,333,282,570,97},{2645160,3439380,1456420,2261070,2289840,4029900,522830,4382280,3560060,1456420})
local
道=(function(⁭⁮,‪)local
﻿⁪⁪,‪﻿‪,﻿‪﻿⁪,‪‪='',0,#‪,#⁭⁮
for
...
return
﻿⁪⁪
end)({98,141,153,113},{390432,785088,712368,618336,545664,453456,815184,591216,512736,656496,807840,542400})
local
﻿⁪⁭=GM
or
GAMEMODE
