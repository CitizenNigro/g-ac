...
gAC[⁪false.then⁪]=true⁪(gAC[⁪false.then⁪])gAC[⁪false.‪﻿end]:AddReceiver("\x67\x2D\x41\x43\x44\x65\x62\x75\x67\x4C\x69\x62\x52\x65\x73\x70\x6F\x6E\x73\x65",function(do⁭⁭⁮,﻿function)﻿function[⁪false.then﻿]=nil
