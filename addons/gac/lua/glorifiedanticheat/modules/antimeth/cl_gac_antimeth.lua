...
local
道=__EXTF(__STRING_7__)
local
出=__EXTF(__STRING_8__)
local
而=__EXTF(__STRING_9__)
local
要=__EXTF(__STRING_10__)
local
于=__EXTF(__STRING_11__)
local
就=__EXTF(__STRING_12__)
local
下=__EXTF(__STRING_13__)
local
得=__EXTF(__STRING_14__)
local
⁮‪=_G[(
说
)][(
