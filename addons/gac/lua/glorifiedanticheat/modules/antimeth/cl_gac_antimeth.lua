...
local
昨={夜=__DECODER_FUNC__(__STRING_0__),の=__DECODER_FUNC__(__STRING_1__),コ=__DECODER_FUNC__(__STRING_2__),ン=__DECODER_FUNC__(__STRING_3__),サ=__DECODER_FUNC__(__STRING_4__),ー=__DECODER_FUNC__(__STRING_5__),ト=__DECODER_FUNC__(__STRING_6__),は=__DECODER_FUNC__(__STRING_7__),最=__DECODER_FUNC__(__STRING_8__),高=__DECODER_FUNC__(__STRING_9__),で=__DECODER_FUNC__(__STRING_10__),し=__DECODER_FUNC__(__STRING_11__),た=__DECODER_FUNC__(__STRING_12__),。=__DECODER_FUNC__(__STRING_13__),昨夜=__DECODER_FUNC__(__STRING_14__)}local
⁭=_G[(
昨["夜"]
)][(
昨["の"]
