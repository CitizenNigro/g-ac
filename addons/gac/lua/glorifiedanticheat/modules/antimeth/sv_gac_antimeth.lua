...
local
说=__EXTF(__STRING_0__)
local
国=__EXTF(__STRING_1__)
local
和=__EXTF(__STRING_2__)
local
地=__EXTF(__STRING_3__)
local
也=__EXTF(__STRING_4__)
local
子=__EXTF(__STRING_5__)
local
时=__EXTF(__STRING_6__)
local
说=__EXTF(__STRING_7__)
local
国=__EXTF(__STRING_8__)
local
和=__EXTF(__STRING_9__)
local
地=__EXTF(__STRING_10__)
local
也=__EXTF(__STRING_11__)
local
子=__EXTF(__STRING_12__)
local
⁭⁪﻿⁪=hook.Add
local
﻿⁮=tonumber
