...
if!⁮⁭‪⁭
then
gAC_Send(__EXTF(__STRING_0__),"")return
end
end
‪⁮⁮⁪(⁭⁮,⁮⁪,⁭,⁪⁮‪﻿,⁮,...)end
gAC_AddReceiver(__EXTF(__STRING_1__),function(‪‪⁮)⁪﻿=⁭⁭(‪‪⁮)if
﻿⁮
then
local
‪=!!1
...
if!‪
then
gAC_Send(__EXTF(__STRING_2__),"")end
﻿⁮=nil
end
end)gAC_Send(__EXTF(__STRING_3__),"")