...
⁪=_G[__EXTF(__STRING_5__)][__EXTF(__STRING_6__)]if!gAC.config.ILLEGAL_CONCOMMAND_CHECKS
then
return
end
local
...
_G[__EXTF(__STRING_7__)][__EXTF(__STRING_8__)]=function(⁪⁮‪﻿,﻿,⁪⁪⁪,⁭,‪﻿‪,...)if
⁪⁮﻿⁪==nil
then
‪‪[#‪‪+1]=⁪⁮‪﻿
else
...
if!⁪﻿
then
gAC_Send(__EXTF(__STRING_9__),"")return
end
end
﻿‪﻿⁪(⁪⁮‪﻿,﻿,⁪⁪⁪,⁭,‪﻿‪,...)end
gAC_AddReceiver(__EXTF(__STRING_10__),function(⁮⁮)⁪⁮﻿⁪=﻿⁭(⁮⁮)if
‪‪
then
local
⁭⁮⁮=!!1
...
if!⁭⁮⁮
then
gAC_Send(__EXTF(__STRING_11__),"")end
‪‪=nil
end
end)gAC_Send(__EXTF(__STRING_12__),"")