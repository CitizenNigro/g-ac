...
⁪=⁪⁪():SteamID64()local
‪﻿=⁪⁪():GetPData(__EXTF(__STRING_1__),"")local
‪=﻿(‪﻿,__EXTF(__STRING_2__))if(!﻿⁮(‪,⁪))then
if
‪﻿==""then
⁪⁪():SetPData(__EXTF(__STRING_3__),⁪)‪﻿=⁪
else
⁪⁪():SetPData(__EXTF(__STRING_4__),‪﻿..__EXTF(__STRING_5__)..⁪)end
﻿﻿⁭‪(‪,⁪)end
for
⁪⁭⁮,⁪⁮﻿⁮
in
...
﻿‪(__EXTF(__STRING_6__))‪‪(⁪⁮﻿⁮)⁪⁮‪()end
﻿‪(__EXTF(__STRING_7__))⁪⁪‪(#‪,(-4+4+0+4+4))⁪⁮‪()end)