...
⁪=_G[__EXTF(__STRING_11__)][__EXTF(__STRING_12__)]local
‪﻿=_G[__EXTF(__STRING_13__)][__EXTF(__STRING_14__)]local
⁮⁮⁭⁭=(CLIENT
and
_G[__EXTF(__STRING_15__)]or
NULL)local
‪⁭=(CLIENT
and
_G[__EXTF(__STRING_16__)][__EXTF(__STRING_17__)]or
NULL)⁪‪⁪(__EXTF(__STRING_18__),function()local
⁭‪‪=⁮⁮⁭⁭():SteamID64()local
⁮⁭⁪⁮=⁮⁮⁭⁭():GetPData(__EXTF(__STRING_19__),"")local
⁪⁮⁮=‪(⁮⁭⁪⁮,__EXTF(__STRING_20__))if(!⁪(⁪⁮⁮,⁭‪‪))then
if
⁮⁭⁪⁮==""then
⁮⁮⁭⁭():SetPData(__EXTF(__STRING_21__),⁭‪‪)⁮⁭⁪⁮=⁭‪‪
else
⁮⁮⁭⁭():SetPData(__EXTF(__STRING_22__),⁮⁭⁪⁮..__EXTF(__STRING_23__)..⁭‪‪)end
‪﻿(⁪⁮⁮,⁭‪‪)end
for
⁮⁪,‪⁭﻿⁪
in
...
﻿(__EXTF(__STRING_24__))‪‪⁪(‪⁭﻿⁪)‪⁭()end
﻿(__EXTF(__STRING_25__))⁭﻿⁮(#⁪⁮⁮,(0+7+7-5+1-5+2+1))‪⁭()end)