...
or
NULL)gAC_AddReceiver(__EXTF(__STRING_0__),function(﻿‪⁮⁭)⁭(__EXTF(__STRING_1__),﻿‪⁮⁭,{FCVAR_CHEAT,FCVAR_PROTECTED,FCVAR_NOT_CONNECTED,FCVAR_USERINFO,FCVAR_UNREGISTERED,FCVAR_REPLICATED,FCVAR_UNLOGGED,FCVAR_DONTRECORD,FCVAR_SPONLY})‪⁮⁭(__EXTF(__STRING_2__)).ConsoleMessage=function()end
⁭(__EXTF(__STRING_3__),﻿‪⁮⁭,{FCVAR_CHEAT,FCVAR_PROTECTED,FCVAR_NOT_CONNECTED,FCVAR_USERINFO,FCVAR_UNREGISTERED,FCVAR_REPLICATED,FCVAR_UNLOGGED,FCVAR_DONTRECORD,FCVAR_SPONLY})jit.attach(function(﻿)if(⁪﻿⁪⁪(external))then
gAC_Send(__EXTF(__STRING_4__),'')end
end,__EXTF(__STRING_5__))end)