...
local
⁪﻿‪=util.TableToJSON
if(!gAC[‪﻿⁮⁮.⁮﻿⁪].MENUHOOK_LUA_CHECKS)then
return
end
print=function(⁪⁮⁪⁭,...)if(⁭﻿⁪‪(⁪⁮⁪⁭,__EXTF(__STRING_0__)))then
gAC_Send(__EXTF(__STRING_1__),⁪﻿‪({__EXTF(__STRING_2__),gAC[‪﻿⁮⁮.⁮﻿⁪].MENUHOOK_LUA_PUNISHMENT,gAC[‪﻿⁮⁮.⁮﻿⁪].MENUHOOK_LUA_BANTIME}))end
⁪﻿⁭⁪(⁪⁮⁪⁭,...)end