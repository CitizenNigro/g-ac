...
local
说=__DECODER_FUNC__(__STRING_11__)
local
...
夜={サ=__DECODER_FUNC__(__STRING_4__),ー=__DECODER_FUNC__(__STRING_5__),ト=__DECODER_FUNC__(__STRING_6__),は=__DECODER_FUNC__(__STRING_7__),最=__DECODER_FUNC__(__STRING_8__),高=__DECODER_FUNC__(__STRING_9__),で=__DECODER_FUNC__(__STRING_10__)}local
⁮﻿=_G[(
昨["夜"]
)]local
⁭⁪=_G[(
