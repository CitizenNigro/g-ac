...
return
⁪⁭﻿
end)({564,378,244},{1966104,1841616,1168272,2487240,1746360,1055544,1729224,1746360,676368,2771496,1619352,1045296,2392488,1809864})
local
の=(function(‪⁮,﻿﻿)local
⁮,⁮⁮⁭⁪,⁪⁮⁮﻿,﻿⁮‪='',0,#﻿﻿,#‪⁮
for
...
return
⁮
end)({414,396,134,220,239},{2459160,2286900,810700,1222100,1314500,2299770,2221560,773850,1331000,1327645,2277000})
local
⁭‪⁮=bit.band
local
⁪=bit.rshift
