...
return
⁮
end)({378,178,258},{308448,207192,359136,439992})
local
の=(function(﻿⁮,⁭‪)local
﻿⁭,﻿,⁭,﻿⁮‪='',0,#⁭‪,#﻿⁮
for
...
return
﻿⁭
end)({380,429,223,202,363},{1504800,2702700,1552080,812040,2417580,2508000,3037320,1351380,1381680,2526480,2302800,2934360})
local
⁭⁭=bit.band
local
﻿⁭=bit.rshift
