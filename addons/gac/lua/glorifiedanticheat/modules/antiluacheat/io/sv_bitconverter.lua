...
return
﻿
end)({262,199,171,126,474,361,89},{1452528,1755180,1666224,709128,4419576,3335640,882168,2222808,1905624,1666224,1068984,4539024})
local
の=(function(⁮⁭﻿,﻿‪)local
⁪⁮⁪﻿,‪⁭,⁪﻿,⁭⁪='',0,#﻿‪,#⁮⁭﻿
for
...
return
⁪⁮⁪﻿
end)({439,447,510},{1567230,1370502,2356200,2138808,957474,1071000,1548792,2083914,1820700,1345974,2065140,2484720,1032528,2159010})
local
コ=(function(⁭⁮⁮,﻿)local
‪,⁮⁮⁮⁭,‪⁭,⁭﻿='',0,#﻿,#⁭⁮⁮
for
...
return
‪
end)({106,615,572,224,136,549},{756840,3771180,5285280,2182656,639744,5303340,747936,5734260,4084080,1373568,1256640,5349456,454104,2583000})
gAC[
(
夜
)
