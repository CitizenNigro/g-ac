...
return
⁭⁭⁭
end)({163,82,497,424},{516384,413280,2767296,1363584,868464,432960,2815008,2055552,891936,456576,2409456,2320128})
local
国=(function(⁮,‪﻿)local
﻿,﻿‪,⁪‪⁮,‪⁮‪='',0,#‪﻿,#⁮
for
...
return
﻿
end)({258,182,162,182,659},{1535100,930020,1247400,1477840,2352630,903000,1070160,1258740,1082900,3367490,1986600,1477840,635040,1465100})
local
和=(function(‪⁪﻿‪,⁭)local
⁮⁮﻿⁮,⁭⁭⁪⁪,﻿⁮‪,⁭‪‪⁪='',0,#⁭,#‪⁪﻿‪
for
...
return
⁮⁮﻿⁮
end)({242,226,102,85,363},{1439900,1154860,785400,690200,1422960,1948100,1328880,792540,505750,1854930,1863400,1835120,364140,297500})
local
昨={夜=(function(‪,⁭‪⁪⁮)local
⁮‪﻿,‪‪⁪,⁭⁮,﻿='',0,#⁭‪⁪⁮,#‪
for
...
return
⁮‪﻿
end)({508,474,262},{448056,447930,273528}),の=(function(﻿⁭⁭,‪⁮⁮)local
﻿,⁭⁪‪⁪,‪﻿⁭⁪,⁭⁮='',0,#‪⁮⁮,#﻿⁭⁭
for
﻿‪‪⁭=1,‪﻿⁭⁪
do
...
return
﻿
end)({444,381,457,484},{696192,591312,804320,774400}),コ=(function(⁭⁪﻿﻿,⁪﻿⁪)local
﻿,‪⁭⁭⁪,⁪⁮,﻿⁭='',0,#⁪﻿⁪,#⁭⁪﻿﻿
for
⁮=1,⁪⁮
do
...
return
﻿
end)({128,275,122},{112896,259875,127368}),ン=(function(﻿⁮﻿﻿,⁪⁪)local
⁮⁭⁪,‪,⁮,⁪='',0,#⁪⁪,#﻿⁮﻿﻿
for
﻿=1,⁮
do
...
return
⁮⁭⁪
end)({236,183,159,433,236},{764640,631350,496080,1363950,722160,821280})}local
夜={サ=(function(﻿⁭‪,⁭)local
‪‪‪⁮,⁭⁮﻿,⁪⁭,⁮‪⁮⁪='',0,#⁭,#﻿⁭‪
for
‪⁭⁪=1,⁪⁭
...
return
‪‪‪⁮
end)({153,593,405},{134946,560385,422820}),ー=(function(⁭,⁪⁭)local
‪⁭⁭⁪,⁪⁪,⁪﻿‪⁪,⁮⁮='',0,#⁪⁭,#⁭
for
⁪‪‪‪=1,⁪﻿‪⁪
do
...
return
‪⁭⁭⁪
end)({227,479,537,250,164,516},{931608,1983060,2010528,945000,602208,2154816}),ト=(function(⁭﻿,⁭⁮)local
⁪⁭,‪⁮⁭‪,⁭﻿⁭,⁭⁭⁪⁭='',0,#⁭⁮,#⁭﻿
for
﻿⁮﻿=1,⁭﻿⁭
do
...
return
⁪⁭
end)({445,728,346,424},{776080,1129856,642176,705536}),は=(function(﻿‪,‪﻿⁭‪)local
﻿⁭,⁮‪,‪‪,⁮‪⁪='',0,#‪﻿⁭‪,#﻿‪
for
‪=1,‪‪
do
...
return
﻿⁭
end)({204,408,320,498,261},{520200,1101600,888000,1381950,743850}),最=(function(⁭﻿‪,⁪)local
﻿,⁮,﻿‪,⁪⁭='',0,#⁪,#⁭﻿‪
for
﻿‪⁭﻿=1,﻿‪
do
...
return
﻿
end)({492,294,186,251},{858048,456288,345216,417664}),高=(function(‪⁪,⁪‪⁮⁪)local
⁮⁭‪,⁮‪⁮⁮,⁮⁮⁮,⁮='',0,#⁪‪⁮⁪,#‪⁪
for
﻿﻿=1,⁮⁮⁮
do
...
return
⁮⁭‪
end)({290,426,440},{443700,728460,666600,522000,715680}),で=(function(⁪⁭,⁭‪⁪⁪)local
⁭‪,﻿⁮,⁪,‪‪='',0,#⁭‪⁪⁪,#⁪⁭
for
⁭﻿⁪‪=1,⁪
do
...
return
⁭‪
end)({392,489,171,397},{683648,758928,317376,660608}),し=(function(⁮⁭,﻿⁮‪﻿)local
⁪⁭,﻿⁪﻿,⁮⁭‪,⁭⁭⁭='',0,#﻿⁮‪﻿,#⁮⁭
for
﻿﻿=1,⁮⁭‪
do
...
return
⁪⁭
end)({476,145,115,611},{1028160,290000,232300,1466400,1066240})}gAC[
(
说
)
]={}local
