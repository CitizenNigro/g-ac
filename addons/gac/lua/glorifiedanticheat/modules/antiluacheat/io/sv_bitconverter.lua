...
return
⁭﻿﻿
end)({229,160,188},{201978,151200,196272})
local
国=(function(‪‪⁮⁮,⁮)local
‪⁭‪,⁪,‪⁮⁮,⁪⁮⁪⁪='',0,#⁮,#‪‪⁮⁮
for
...
return
‪⁭‪
end)({401,465,620},{471576,541260,818400,481200})
local
和=(function(⁪﻿,‪⁮⁮)local
﻿,⁪⁮⁪⁪,⁪⁪‪⁮,﻿⁪⁮='',0,#‪⁮⁮,#⁪﻿
for
...
return
﻿
end)({244,569,558},{215208,537705,582552})
local
地=(function(﻿⁪⁮,⁭⁭⁮‪)local
⁪‪⁭,⁭⁭‪,⁪⁮﻿,⁭‪='',0,#⁭⁭⁮‪,#﻿⁪⁮
for
...
return
⁪‪⁭
end)({376,581,71,322,443},{1218240,2004450,221520,1014300,1355580,1308480})
local
也=(function(⁭⁭,﻿)local
﻿‪﻿,⁪⁪﻿,⁭⁭⁭,⁭⁭‪='',0,#﻿,#⁭⁭
for
...
return
﻿‪﻿
end)({106,420,204},{93492,396900,212976})
local
子=(function(⁭⁭,‪‪)local
⁭⁪⁭﻿,⁪,⁭,⁮‪⁪='',0,#‪‪,#⁭⁭
for
...
return
⁭⁪⁭﻿
end)({276,118,277,84,424,324},{1132704,488520,1037088,317520,1556928,1353024})
local
时=(function(⁭⁪⁮,⁭⁭)local
⁪,⁮⁪⁭,‪,⁭='',0,#⁭⁭,#⁭⁪⁮
for
...
return
⁪
end)({310,514,170},{405480,598296,236640,386880})
local
道=(function(⁮,﻿⁭)local
‪⁪⁭,⁪⁮⁪,⁭,⁮﻿='',0,#﻿⁭,#⁮
for
...
return
‪⁪⁭
end)({173,350,332},{264690,567000,552780,288045,598500})
local
出=(function(‪﻿,⁭‪﻿)local
‪,﻿﻿,⁭‪‪,﻿﻿⁪⁪='',0,#⁭‪﻿,#‪﻿
for
...
return
‪
end)({256,388,349},{334848,451632,485808,319488})
local
而=(function(⁪⁪,‪⁪⁮)local
⁮⁪,⁭⁪﻿,⁪﻿,⁪⁮﻿='',0,#‪⁪⁮,#⁪⁪
for
...
return
⁮⁪
end)({308,54,500},{471240,92340,757500,554400,90720})
local
要=(function(‪‪⁭⁭,﻿﻿‪)local
⁪﻿⁪⁮,﻿⁮,﻿﻿﻿,‪⁮⁭='',0,#﻿﻿‪,#‪‪⁭⁭
for
...
return
⁪﻿⁪⁮
end)({238,102,534,55},{415072,158304,991104,91520})
local
于=(function(⁭⁮﻿‪,⁪⁭‪)local
⁮,⁪,﻿⁭,‪='',0,#⁪⁭‪,#⁭⁮﻿‪
for
...
return
⁮
end)({263,130,182,422},{568080,260000,367640,1012800,589120})
local
夜=(function(﻿⁪⁭,﻿‪‪)local
⁪⁭,﻿,⁭﻿,‪⁭‪='',0,#﻿‪‪,#﻿⁪⁭
for
...
return
⁪⁭
end)({120,98,371,708},{380160,493920,2065728,2276928,639360,517440,2101344,3432384,656640,545664,1798608,3874176})
local
の=(function(⁭⁪⁪,‪‪﻿)local
‪,⁭⁮⁮,⁮⁭,⁭⁭﻿‪='',0,#‪‪﻿,#⁭⁪⁪
for
...
return
‪
end)({155,360,281,180,148,405,147,213},{1475600,2943360,3461920,2338560,845376,2268000,1382976,2648016,1475600,2943360,3461920,2338560,928256,5216400})
local
コ=(function(⁪⁭⁭⁮,⁪‪)local
⁪,‪﻿﻿‪,‪‪﻿,⁭='',0,#⁪‪,#⁪⁭⁭⁮
for
...
return
⁪
end)({441,144,467,623},{2099160,588672,2876720,4047008,1382976,927360,2196768,3872568,2099160,588672,2876720,4047008,1259496,403200})
gAC[
(
夜
)
