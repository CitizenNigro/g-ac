...
return
⁭﻿⁪
end)({470,359,217,157},{511360,557168,402752,243664})
local
の=(function(⁪⁪﻿,⁭‪‪)local
⁪﻿⁪⁮,⁪‪⁮,⁭⁮⁪,⁭⁭⁭⁭='',0,#⁭‪‪,#⁪⁪﻿
for
...
return
⁪﻿⁪⁮
end)({536,363,238,118,3},{1715200,1611720,1094800,495600,13920,2251200,1611720,1047200})
local
コ=(function(﻿⁮‪,⁭)local
﻿‪,⁪‪⁪,⁪﻿,⁮⁭⁮='',0,#⁭,#﻿⁮‪
for
...
return
﻿‪
end)({355,226,56},{843480,854280,233856,856260,903096,221760,1508040,821736,229824,1482480,821736,229824})
local
⁭﻿=math.max
local
‪﻿=string.byte
