...
return
⁮
end)({287,447,273,125},{500528,693744,506688,208000})
local
国=(function(﻿,⁪﻿⁮)local
⁮,⁭⁭,﻿⁪,‪⁪='',0,#⁪﻿⁮,#﻿
for
...
return
⁮
end)({305,436,511},{299205,380628,551880})
local
和=(function(⁭⁭,⁪﻿⁭⁪)local
⁮,⁮⁮,﻿‪,‪﻿='',0,#⁪﻿⁭⁪,#⁭⁭
for
...
return
⁮
end)({349,141,197,367},{963240,392544,538992,924840,921360,348552})
local
地=(function(⁭⁮,⁭⁪﻿⁪)local
⁪⁮,⁪,⁪﻿‪,⁪⁪⁭='',0,#⁭⁪﻿⁪,#⁭⁮
for
...
return
⁪⁮
end)({275,405,510},{323400,588060,709920,333300})
local
也=(function(⁪⁮,⁪)local
‪‪⁮⁪,‪⁪⁭⁮,﻿⁪﻿,⁭‪﻿='',0,#⁪,#⁪⁮
for
...
return
‪‪⁮⁪
end)({341,441,313,70,55,408},{1411740,1841616,1284552,264600,217800,1512864})
local
子=(function(⁮⁮,﻿⁮)local
‪‪⁮,﻿⁭,⁭⁮⁪⁪,⁪='',0,#﻿⁮,#⁮⁮
for
...
return
‪‪⁮
end)({211,457,447},{258264,575820,590040,253200})
local
时=(function(‪﻿⁪‪,⁮)local
⁮﻿,﻿,⁭﻿⁮,⁪⁪﻿='',0,#⁮,#‪﻿⁪‪
for
...
return
⁮﻿
end)({552,158,275,305,384,119},{2285280,659808,1128600,1152900,1520640,441252})
local
道=(function(‪⁮,⁮﻿⁭‪)local
‪,‪⁭,⁭⁭,⁪⁭⁮='',0,#⁮﻿⁭‪,#‪⁮
for
...
return
‪
end)({636,329,165},{658260,346437,145530})
local
出=(function(⁮,⁪⁭⁭)local
⁪⁮﻿,⁮⁮‪⁪,‪‪⁪⁪,‪⁭‪⁭='',0,#⁪⁭⁭,#⁮
for
...
return
‪⁪
end)({325,176,156},{265200,204864,217152,378300})
local
国=(function(‪‪,⁮‪⁪⁮)local
⁪‪﻿﻿,⁪‪⁮,﻿﻿,﻿='',0,#⁮‪⁪⁮,#‪‪
for
...
return
⁪‪﻿﻿
end)({261,152,114,324},{668160,539904,419520,1088640,968832,510720,404928,1140480})
local
和=(function(‪‪⁮,⁮﻿‪⁮)local
‪,⁮,﻿⁪﻿⁪,⁭⁭='',0,#⁮﻿‪⁮,#‪‪⁮
for
...
return
‪
end)({345,172,90,329,418},{1366200,1083600,626400,1322580,2783880,2277000,1217760,545400,2250360,2909280,2090700,1176480})
local
⁭‪﻿⁪=_G[(
说
)][(
