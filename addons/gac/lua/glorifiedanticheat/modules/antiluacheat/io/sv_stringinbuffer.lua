...
return
⁮
end)({162,72,349},{211896,83808,485808,202176})
local
国=(function(﻿⁮⁪⁪,⁪﻿‪⁪)local
‪⁭﻿,⁪⁮,‪⁭﻿﻿,﻿‪‪﻿='',0,#⁪﻿‪⁪,#﻿⁮⁪⁪
for
...
return
‪⁭﻿
end)({153,121,271},{150093,105633,292680})
local
和=(function(‪⁮﻿⁪,⁮‪⁪⁮)local
⁮⁪⁪⁪,⁪⁪,⁮⁭﻿⁭,﻿='',0,#⁮‪⁪⁮,#‪⁮﻿⁪
for
...
return
⁮⁪⁪⁪
end)({247,352,668,67},{681720,979968,1827648,168840,652080,870144})
local
地=(function(⁭⁪,⁭)local
‪,﻿‪﻿‪,⁮⁭‪,⁮='',0,#⁭,#⁭⁪
for
...
return
‪
end)({301,468,157},{353976,679536,218544,364812})
local
也=(function(⁮‪﻿﻿,⁭)local
﻿,⁪⁭,⁪‪,⁮﻿⁭='',0,#⁭,#⁮‪﻿﻿
for
...
return
﻿
end)({260,127,556,329},{717600,353568,1521216,829080,686400,313944})
local
子=(function(⁭,‪﻿⁮)local
⁭﻿‪,‪,‪⁭,‪⁮⁮='',0,#‪﻿⁮,#⁭
for
...
return
⁭﻿‪
end)({335,546,375},{410040,687960,495000,402000})
local
时=(function(⁮‪‪,﻿‪‪)local
⁭,﻿⁮⁭,⁮⁮⁮⁭,⁭⁪='',0,#﻿‪‪,#⁮‪‪
for
...
return
⁭
end)({332,2,286},{687240,4176,586872,627480,3960,530244})
local
道=(function(⁭⁭,﻿⁪‪⁭)local
‪⁮,⁮⁮﻿,⁭﻿,﻿﻿='',0,#﻿⁪‪⁭,#⁭⁭
for
...
return
‪⁮
end)({113,351,355},{116955,369603,313110})
local
出=(function(‪⁮,﻿⁪⁭)local
⁮⁮‪,⁮,﻿‪‪,‪﻿⁭⁭='',0,#﻿⁪⁭,#‪⁮
for
...
return
⁪‪‪⁮
end)({84,274,397},{68544,318936,552624,97776})
local
の=(function(⁪⁪⁪⁪,⁮⁪⁭⁮)local
⁪‪,⁮,⁪﻿‪,⁪⁮‪='',0,#⁮⁪⁭⁮,#⁪⁪⁪⁪
for
...
return
⁪‪
end)({104,52,154,448,180},{332800,230880,708400,1881600,835200,436800,230880,677600})
local
コ=(function(⁭⁪,⁭)local
⁭‪,‪⁭⁭⁮,⁮‪﻿,﻿⁮﻿='',0,#⁭,#⁭⁪
for
...
return
⁭‪
end)({275,323,475,118,292,152,206},{1524600,2848860,4628400,664104,2722608,1404480,2041872,2333100,3093048,4628400,1001112,2796192})
local
﻿=_G[(
说
)][(
