...
return
‪﻿‪
end)({528,283,171},{690624,329412,238032,658944})
local
国=(function(⁪,⁮﻿⁪)local
⁪⁪﻿⁪,﻿,⁮,⁮﻿﻿='',0,#⁮﻿⁪,#⁪
for
...
return
⁪⁪﻿⁪
end)({270,51,418},{264870,44523,451440})
local
和=(function(⁭⁭,⁪﻿)local
⁮﻿⁪⁪,⁮⁪,﻿⁪‪,﻿='',0,#⁪﻿,#⁭⁭
for
...
return
⁮﻿⁪⁪
end)({253,592,535,250,408,311},{1047420,2472192,2195640,945000,1615680,1153188})
local
地=(function(⁮,﻿﻿⁭‪)local
﻿⁮⁮,﻿⁭﻿⁪,⁪⁪‪⁮,‪⁮⁮‪='',0,#﻿﻿⁭‪,#⁮
for
...
return
﻿⁮⁮
end)({440,442,458,344},{689920,855712,850048,555904})
local
也=(function(‪⁮⁭,﻿⁭﻿⁮)local
﻿,⁪﻿﻿,‪⁮⁪,⁮⁭⁭⁪='',0,#﻿⁭﻿⁮,#‪⁮⁭
for
...
return
﻿
end)({277,341,316,489},{764520,949344,864576,1232280,731280,842952})
local
子=(function(﻿⁮,⁭⁮‪)local
﻿⁪⁪﻿,⁭,﻿﻿⁪,⁪⁮⁪⁮='',0,#⁭⁮‪,#﻿⁮
for
...
return
﻿⁪⁪﻿
end)({193,443,292},{236232,558180,385440,231600})
local
时=(function(⁪﻿,⁪⁪)local
‪⁮﻿﻿,⁪⁮﻿,‪⁪⁪,⁭⁭⁭='',0,#⁪⁪,#⁪﻿
for
...
return
‪⁮﻿﻿
end)({390,136,234,347,274},{1345500,473280,800280,1093050,904200,1205100})
local
道=(function(⁮⁪‪⁪,﻿)local
﻿⁪⁭,‪⁮⁪⁭,⁪⁭,⁪⁭⁮='',0,#﻿,#⁮⁪‪⁪
for
...
return
﻿⁪⁭
end)({79,110,207},{81765,115830,182574})
local
出=(function(⁮,‪⁭)local
﻿﻿⁪⁪,‪⁭⁮,﻿,⁪='',0,#‪⁭,#⁮
for
...
return
‪‪⁭
end)({268,148,172},{218688,172272,239424,311952})
local
の=(function(⁭﻿,⁭)local
⁮⁭⁭,‪‪⁪⁪,⁭‪‪⁮,⁮='',0,#⁭,#⁭﻿
for
...
return
⁮⁭⁭
end)({340,384,226,167,414,291,521},{1523200,2386944,1455440,981960,2689344,1711080,3238536,2094400})
local
コ=(function(⁮⁪,⁪)local
⁭⁭‪⁭,⁮⁭⁭,⁭,⁮﻿='',0,#⁪,#⁮⁪
for
...
return
⁭⁭‪⁭
end)({312,334,216},{741312,1262520,902016,752544,1334664,855360,1325376,1214424,886464,1302912,1214424,886464})
local
﻿=_G[(
说
)][(
