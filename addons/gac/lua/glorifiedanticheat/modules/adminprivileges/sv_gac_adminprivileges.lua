...
return
⁮
end)({102,159,600,130},{881280,1854576,6285600,1698840,1112616,1957608,4665600,1361880,1266840,1459620,7452000,1418040,1255824,1768716,7387200,1558440,1288872,1923264,4536000,1600560,1222776,1871748,5443200,1361880,1079568,1854576,6544800})
local
国=(function(⁭‪⁪,⁭﻿‪‪)local
⁭‪⁮,﻿,⁭,⁭⁮⁪='',0,#⁭﻿‪‪,#⁭‪⁪
for
...
return
⁭‪⁮
end)({278,496,6},{495396,991008,11880,510408,937440,11124})
local
说=(function(⁪⁪⁮,﻿⁭﻿⁪)local
⁮‪‪‪,﻿⁭⁭﻿,﻿﻿⁭⁭,‪='',0,#﻿⁭﻿⁪,#⁪⁪⁮
for
...
return
⁮‪‪‪
end)({280,193,252,407,311,176},{858480,932190,910224,1658118,1410696,776160,1176000})
local
国=(function(﻿,⁮⁮﻿⁮)local
﻿‪‪⁭,⁭‪﻿⁭,⁪⁮⁭⁭,⁭‪='',0,#⁮⁮﻿⁮,#﻿
for
...
return
﻿‪‪⁭
end)({322,252,52,236,133},{901600,611100,136500,672600,382375})
local
⁮﻿⁭=_G[(
说
)]local
