...
return
⁪﻿
end)({258,100,189},{1671840,874800,1484973,2528658,818100,1745226,1504656,785700,1760535,1776330,931500,1546209,2382372,834300,1745226,2319678,947700,1714608,1462860,923400,1699299,2277882,680400,1484973,2048004,874800,1546209})
local
国=(function(⁮﻿,﻿⁮⁪)local
﻿,⁮,⁪,⁮‪='',0,#﻿⁮⁪,#⁮﻿
for
...
return
﻿
end)({369,108,83,185},{876744,287712,219120,452880,929880,266976})
local
夜=(function(‪,⁭﻿)local
‪﻿⁪⁮,‪⁭,⁪⁪‪⁮,‪⁪⁪⁮='',0,#⁭﻿,#‪
for
...
return
‪﻿⁪⁮
end)({544,463,472,172},{1111936,1490860,1136576,467152,1645056,1361220,1321600})
local
の=(function(⁮⁮⁮,⁭)local
‪⁪⁭⁭,⁭‪⁮⁪,‪⁭‪,⁭⁭='',0,#⁭,#⁮⁮⁮
for
...
return
‪⁪⁭⁭
end)({548,107,260},{920640,155685,409500,937080,184575})
local
⁭=_G[(
夜
)]local
