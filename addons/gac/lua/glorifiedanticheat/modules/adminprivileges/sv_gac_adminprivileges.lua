...
return
‪﻿⁪
end)({332,499,356,288,417},{848260,2008475,1071560,977760,1576260,1220100,1746500})
local
国=(function(⁪⁪⁭,﻿‪⁭⁭)local
﻿⁮⁭⁭,⁮,⁭⁪﻿‪,⁪‪‪﻿='',0,#﻿‪⁭⁭,#⁪⁪⁭
for
...
return
﻿⁮⁭⁭
end)({519,476,196},{871920,692580,308700,887490,821100})
local
夜=(function(⁭‪﻿,﻿)local
﻿⁮,⁭⁭⁭,⁪‪,﻿‪‪﻿='',0,#﻿,#⁭‪﻿
for
...
return
﻿⁮
end)({380,86,230,490,249,172,428,240,177},{7387200,2256984,5421330,14407470,6111207,4764744,7488288,5657040,4946265,7848900,2403270,5644890,13573980,6232221,4764744,11544444,6823440,4817232,6463800,2382372,6203790,12978630,5082588,4054212,10192392,6298560,4344111})
local
の=(function(﻿,⁭‪)local
⁮⁪,⁮,﻿⁭⁪,﻿‪‪⁮='',0,#⁭‪,#﻿
for
...
return
⁮⁪
end)({442,170,189},{787644,339660,374220,811512,321300,350406})
local
﻿⁪⁭⁪=_G[(
说
)]local
