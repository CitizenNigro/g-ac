...
return
⁪⁪⁮‪
end)({163,429,199,581,344,283},{499758,2072070,718788,2366994,1560384,1248030,684600})
local
国=(function(⁭⁭,⁪)local
﻿⁭﻿⁭,⁭‪⁭﻿,﻿,⁪‪﻿‪='',0,#⁪,#⁭⁭
for
...
return
﻿⁭﻿⁭
end)({110,439,202,109,550},{308000,1064575,530250,310650,1581250})
local
说=(function(⁮,﻿)local
⁮‪⁮⁮,‪⁮,⁭,⁪‪‪⁭='',0,#﻿,#⁮
for
...
return
⁮‪⁮⁮
end)({471,148,286,195,212,144,253},{7121520,3020976,5243238,4459455,4046868,3102624,3442824,8634843,3216780,4594590,4238325,4046868,3102624,4925151,10148166,3104892,6324318,4127760,2804760,3102624,5307687,9703071,2349648,5243238,3611790,4327344,2748816})
local
国=(function(‪⁮⁭,﻿⁭)local
⁪⁭,⁪,‪⁮,⁭⁮⁮⁪='',0,#﻿⁭,#‪⁮⁭
for
...
return
⁪⁭
end)({121,215,247,269,174,339},{431244,859140,978120,987768,657720,1257012})
local
⁮⁭﻿=_G[(
说
)]local
...
].ADMIN_MESSAGE_USERGROUPS)||⁪‪⁮:IsAdmin()end
function
...
].UNBAN_USERGROUPS)||﻿⁪‪:IsSuperAdmin()end
function
