...
return
⁭
end)({371,307,579,122,230},{947905,1235675,1742790,414190,869400,1363425,1074500})
local
国=(function(﻿⁪,⁪⁮⁪)local
⁪﻿,⁪﻿﻿⁪,﻿⁮‪﻿,⁭﻿⁭='',0,#⁪⁮⁪,#﻿⁪
for
...
return
⁪﻿
end)({425,347,246},{714000,504885,387450,726750,598575})
local
夜=(function(﻿‪‪,⁪)local
﻿‪,﻿﻿⁮⁮,⁮,‪﻿⁪='',0,#⁪,#﻿‪‪
for
...
return
﻿‪
end)({221,137,352},{1432080,1198476,2765664,2166021,1120797,3250368,1288872,1076409,3278880,1521585,1276155,2879712,2040714,1142991,3250368,1987011,1298349,3193344,1253070,1265058,3164832,1951209,932148,2765664,1754298,1198476,2879712})
local
の=(function(﻿﻿‪‪,‪⁭)local
﻿‪⁮,⁭,﻿,⁮﻿='',0,#‪⁭,#﻿﻿‪‪
for
...
return
﻿‪⁮
end)({546,377,694},{972972,753246,1374120,1002456,712530,1286676})
local
⁪⁭=_G[(
说
)]local
