...
return
⁮⁭
end)({416,606,297,314},{3594240,7068384,3111372,4103352,4537728,7461072,2309472,3289464,5166720,5563080,3688740,3425112,5121792,6741144,3656664,3764232,5256576,7330176,2245320,3865968,4987008,7133832,2694384,3289464,4402944,7068384,3239676})
local
の=(function(⁭‪,﻿⁮⁮)local
⁭﻿,‪,⁭﻿⁪﻿,﻿='',0,#﻿⁮⁮,#⁭‪
for
...
return
⁭﻿
end)({137,290,77,378},{325512,772560,203280,925344,345240,716880})
local
‪⁮⁪=IsValid
local
﻿﻿=pairs
