...
local
﻿﻿={⁪='\x50\x6C\x61\x79\x65\x72\x48\x61\x73\x55\x73\x65\x72\x67\x72\x6F\x75\x70\x46\x72\x6F\x6D\x54\x61\x62\x6C\x65',‪⁪='\x63\x6F\x6E\x66\x69\x67'}local
‪⁭⁪=_G[(function(⁮,⁮⁪⁪)local
⁪‪⁮‪,⁪‪,⁮⁪⁭,⁪⁪⁭='',0,#⁮⁪⁪,#⁮
for
‪⁪‪=1,⁮⁪⁭
...
‪﻿⁮..''~=‪﻿⁮
then
⁪‪⁮‪=⁪‪⁮‪..__CHAR(__XOR(‪﻿⁮,⁮[⁪‪]%(223-317+32-61+237+141),(⁮⁪⁭*⁪⁪⁭)%(-81+142-1-19-66+43+99+138)))else
⁪‪⁮‪=⁪‪⁮‪..‪﻿⁮
end
if
⁪‪==⁪⁪⁭
...
return
⁪‪⁮‪
end)({(-642-247+392-105+434+528-1),(120-135+155+170-125+15+163-1),(172+373)},{(-20+59+13),(7-6+6-5-1+5+7),(86+73-56-5-14+20+41-50+1),(170-142),(33+77-75-64+16-47+77+1),(-838+933),(-87+56+28+36-39+34-3)})]local
⁭⁭⁪=_G[(function(⁭⁭﻿,﻿‪⁪⁭)local
⁮‪⁮⁮,‪﻿,﻿﻿⁪,⁮='',0,#﻿‪⁪⁭,#⁭⁭﻿
for
⁪⁮⁪﻿=1,﻿﻿⁪
...
⁭⁪⁭‪..''~=⁭⁪⁭‪
then
⁮‪⁮⁮=⁮‪⁮⁮..__CHAR(__XOR(⁭⁪⁭‪,⁭⁭﻿[‪﻿]%(231-254-199-154+227+236+168),(﻿﻿⁪*⁮)%(-46+102+199)))else
⁮‪⁮⁮=⁮‪⁮⁮..⁭⁪⁭‪
end
if
‪﻿==⁮
...
return
⁮‪⁮⁮
end)({(172+170),(-1527-1295-38+2398+1057-1),(460-189),(238+227-72-90+1),(279-306-266+264+251+262+1)},{(-129+148+60-17),(8+18+18),(-214+310),(-57+31+55-31+54+21+16+1),(58-8+16+43-14-4+12+38-1)})]function
gAC.PlayerHasAdminMessagePerm(‪)return
gAC[﻿﻿.⁪](‪,gAC[﻿﻿.‪⁪].ADMIN_MESSAGE_USERGROUPS)||‪:IsAdmin()end
function
gAC.PlayerHasUnbanPerm(‪⁮)return
gAC[﻿﻿.⁪](‪⁮,gAC[﻿﻿.‪⁪].UNBAN_USERGROUPS)||‪⁮:IsSuperAdmin()end
function
gAC.PlayerHasUsergroupFromTable(﻿⁭⁮,‪﻿﻿)if!‪⁭⁪(﻿⁭⁮)and
﻿⁭⁮==NULL
then
return!!1
end
