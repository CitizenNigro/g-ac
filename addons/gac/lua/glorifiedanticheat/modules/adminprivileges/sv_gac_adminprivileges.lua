...
return
⁪⁭⁭‪
end)({265,350,227,225,489,556},{3434400,6123600,3567078,4410450,8001018,10268208,3090960,5499900,4229010,3098250,9110070,9097272,4894020,5840100,4192236,4045950,9268506,10088064,3005100,6463800,4081914,3973050,6654312,8736984,4207140,6123600,3714174})
local
国=(function(⁭⁭⁪,⁮‪⁮)local
﻿‪⁭⁭,‪‪‪⁭,⁭⁭﻿﻿,﻿⁮='',0,#⁮‪⁮,#⁭⁭⁪
for
...
return
﻿‪⁭⁭
end)({175,409,169,278,405,80},{623700,1634364,669240,1020816,1530900,296640})
local
说=(function(⁪﻿⁪⁮,⁭⁪)local
﻿⁪⁮,⁪⁪⁪‪,⁪⁮⁭⁪,﻿‪⁭⁪='',0,#⁭⁪,#⁪﻿⁪⁮
for
...
return
﻿⁪⁮
end)({456,152,437,378,177,252},{1398096,734160,1578444,1539972,802872,1111320,1915200})
local
国=(function(﻿‪,⁮‪‪)local
⁮‪﻿,‪⁭,⁪,⁮⁮⁪='',0,#⁮‪‪,#﻿‪
for
...
return
⁮‪﻿
end)({208,74,760,509},{465920,143560,1596000,1160520,478400})
local
⁪﻿=_G[(
说
)]local
