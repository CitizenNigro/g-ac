...
return
﻿
end)({329,346,569},{725445,799260,1182951,746172,850122,1194900,697809})
local
国=(function(﻿⁮⁪﻿,‪﻿‪‪)local
﻿‪⁪⁭,﻿,⁮⁮⁮⁭,⁪='',0,#‪﻿‪‪,#﻿⁮⁪﻿
for
...
return
﻿‪⁪⁭
end)({306,213,220},{2322540,1419858,1655280,2383128,1419858,1655280,949212,1602612,1466520,2261952,1518264,1408440,1999404,1419858,1582680,2039796,1546380,1684320,929016,1518264,1698840,1959012})
local
和=(function(⁭⁪‪,‪﻿﻿﻿)local
⁭﻿,﻿‪﻿‪,⁮⁭⁪‪,⁭﻿⁪='',0,#‪﻿﻿﻿,#⁭⁪‪
for
...
return
⁭﻿
end)({148,241,5,435,125,133,333,54},{923520,2313600,48000,2797920,996000,970368,3740256,502848,994560,2429280,51840,4217760})
local
地=(function(‪⁮﻿,⁭⁮﻿⁮)local
⁮⁪,﻿‪,‪﻿﻿⁪,‪='',0,#⁭⁮﻿⁮,#‪⁮﻿
for
...
return
⁮⁪
end)({235,211,304,518},{440860,691236,970368,1218336,690900,643972,859712})
local
也=(function(⁭‪⁪,⁮‪﻿⁪)local
⁮⁭,⁮‪⁭﻿,‪﻿⁭,﻿﻿='',0,#⁮‪﻿⁪,#⁭‪⁪
for
...
return
⁮⁭
end)({559,517,375,390,446,700,248},{1835197,2963961,2094750,1605240,2294670,3738700,1227352})
if
SERVER
then
_G[(
