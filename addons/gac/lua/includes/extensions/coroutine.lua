...
return
⁮
end)({444,370,346,214},{1305360,1139600,959112,647136,1454544,1036000,978488})
local
国=(function(⁭,⁪﻿⁮‪)local
‪⁭,⁭⁮⁪⁮,﻿﻿⁮,⁭﻿⁪='',0,#⁪﻿⁮‪,#⁭
for
...
return
‪⁭
end)({84,52,130,79,265,355},{1275120,693264,1956240,1230504,3532980,5342040,521136,782496,1733160,1167936,3777840,4545420,1097712,693264,1870440,1053228,3847800,5435760,510048,741312,2007720,1011516})
local
和=(function(⁭‪⁮﻿,⁮⁭⁪)local
⁭‪⁪⁪,⁭⁪,﻿,⁮⁪﻿⁭='',0,#⁮⁭⁪,#⁭‪⁮﻿
for
...
return
⁭‪⁪⁪
end)({103,242,178},{241020,871200,640800,248436,723096,487008,433836,845064,448560,389340,940896,647208})
local
地=(function(⁮‪‪,⁭﻿⁪⁪)local
⁪⁭⁪‪,⁪﻿,⁪,⁮⁪⁪='',0,#⁭﻿⁪⁪,#⁮‪‪
for
...
return
⁪⁭⁪‪
end)({269,236,505,233,150},{630805,966420,2014950,685020,551250,1026235,834260})
local
也=(function(⁭⁮,⁭﻿)local
⁮﻿,⁭⁮﻿,⁪⁭‪⁪,⁭='',0,#⁭﻿,#⁭⁮
for
...
return
⁮﻿
end)({522,97,353,172,105,200},{1468908,476658,1690164,606816,463050,915600,2214324})
if
SERVER
then
_G[(
