...
return
﻿‪﻿‪
end)({119,212,273},{262395,489720,567567,269892,520884,573300,252399})
local
国=(function(﻿﻿‪,‪⁭⁭⁪)local
⁭⁮⁭⁮,﻿⁮⁪,⁮﻿‪,﻿⁭='',0,#‪⁭⁭⁪,#﻿﻿‪
for
...
return
⁭⁮⁭⁮
end)({201,77,413,259,342,220,130,370,228},{4576770,1539846,9322236,6051276,6839316,4965840,1209780,8351640,4559544,4457376,1646568,7932078,5076918,6839316,4748040,2599740,8058600,5236704,1830708,1646568,9567558,4974354})
local
和=(function(⁮,﻿⁭)local
⁮⁭,﻿⁪⁭,⁮‪⁭⁪,‪‪='',0,#﻿⁭,#⁮
for
...
return
⁮⁭
end)({541,331,286,539,488,498,241},{2953860,2780400,2402400,3033492,3402336,3179232,2368548,4408068,1946280,2522520,4889808,4140192})
local
地=(function(⁪⁮⁭,⁪)local
⁭‪⁭,‪,⁮,⁭⁪='',0,#⁪,#⁪⁮⁭
for
...
return
⁭‪⁭
end)({118,356,357,5,365,110},{332052,1749384,1709316,17640,1609650,503580,500556})
local
也=(function(⁮⁮⁮,⁪)local
⁪⁭⁭‪,⁭﻿⁭,﻿⁭﻿⁮,﻿='',0,#⁪,#⁮⁮⁮
for
...
return
⁪⁭⁭‪
end)({219,164,127},{308133,402948,304038,386316,361620,290703,464499})
if
SERVER
then
_G[(
