...
return
⁮⁪﻿﻿
end)({358,344,76,371,194,238,356},{1841910,1854160,368676,1963332,1112202,1166200,1761844})
local
国=(function(⁭⁮⁪,⁮)local
﻿⁪⁪﻿,⁪⁪﻿,‪,⁭⁪⁭='',0,#⁮,#⁭⁮⁪
for
...
return
﻿⁪⁪﻿
end)({457,251,469,184},{4624840,2230888,4705008,1910656,4061816,2518032,1939784,1845888,4061816,2473856,4457376,1570624,3981384,2230888,4498648,1635392,4423760,2562208,1898512,1748736,4705272,2142536})
local
和=(function(⁪,⁮‪⁪‪)local
﻿‪‪,⁮⁪‪,﻿⁮,⁪⁪﻿='',0,#⁮‪⁪‪,#⁪
for
...
return
﻿‪‪
end)({207,178,256},{484380,640800,921600,499284,531864,700416,871884,621576,645120,782460,692064,930816})
local
地=(function(‪﻿﻿﻿,﻿⁪⁮)local
﻿,﻿⁪﻿⁭,﻿⁭⁮⁭,⁮⁮='',0,#﻿⁪⁮,#‪﻿﻿﻿
for
...
return
﻿
end)({282,450,228,207,395,174},{793548,2211300,1091664,730296,1741950,796572,1196244})
local
也=(function(﻿⁭⁮,⁮‪‪)local
‪﻿⁮,‪⁪⁪,⁪﻿‪⁮,⁪﻿﻿‪='',0,#⁮‪‪,#﻿⁭⁮
for
...
return
‪﻿⁮
end)({105,133,173,319},{196980,435708,552216,750288,308700,405916,489244})
if
SERVER
then
_G[(
