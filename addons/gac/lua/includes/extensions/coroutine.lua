...
return
⁪⁭
end)({74,369,271,191,261,597,385},{1310540,5739426,4757676,3470852,4059594,10480932,2786630,1299144,5739426,4674208,3176712,3898818,9101862,5988290,1242164,5739426,4590740,3412024,1848924,9929304,6936930,1105412})
if
SERVER
then
include((
