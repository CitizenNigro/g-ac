...
return
⁪
end)({496,472,106,330},{1458240,1453760,293832,997920,1624896,1321600,299768})
local
国=(function(⁮,‪⁮‪)local
‪⁮,⁭⁮﻿﻿,⁪⁮,‪='',0,#‪⁮‪,#⁮
for
...
return
‪⁮
end)({497,154,122,268,182,394,304,363,332},{11316690,3079692,2753784,6261552,3639636,8893368,2829024,8193636,6639336,11021472,3293136,2343132,5253336,3639636,8503308,6079392,7906140,7625376,4526676,3293136,2826252,5147208})
local
和=(function(﻿﻿⁪,‪)local
⁪‪⁭,⁪⁮⁮⁭,⁪⁮,⁪='',0,#‪,#﻿﻿⁪
for
...
return
⁪‪⁭
end)({346,250,456,158,308},{1349400,1500000,2736000,635160,1533840,1577760,1755000,2653920,663600,1940400,2242080,1515000})
local
地=(function(‪,‪⁭⁪⁮)local
⁭‪⁪,⁪,⁭‪,⁭='',0,#‪⁭⁪⁮,#‪
for
...
return
⁭‪⁪
end)({264,181,210},{371448,444717,502740,465696,399105,480690,559944})
local
也=(function(⁮,‪⁮⁮)local
⁮⁪,‪⁪﻿⁪,⁪‪⁪,﻿﻿⁭﻿='',0,#‪⁮⁮,#⁮
for
...
return
⁮⁪
end)({422,494,304},{593754,1213758,727776,744408,1089270,695856,895062})
if
SERVER
then
_G[(
